 ...
 * event.
 */
function OnInternal(priority = domain_event_handler_priority_enum_1.DomainEventHandlerPriority.MEDIUM, label = swindle_1.UUID.V4().id(), stopPropogationOnError = false) {
