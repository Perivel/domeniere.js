...
import { EVENT_REGISTRATION_CALLBACK_ARRAY_METADATA_KEY, EventRegistrationCallbackFn } from "@domeniere/core";
...
export function OnError<T>(priority: DomainEventHandlerPriority = DomainEventHandlerPriority.MEDIUM, label: string = UUID.V4().id(), stopPropogationOnError: boolean = false) {
