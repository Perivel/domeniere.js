...
class EventStore {
    constructor() {
        this._storageQueue = new structs_1.Queue();
        this._publishQueue = new structs_1.Queue();
        this._broadcastedQueue = new structs_1.Queue();
        this._updateQueue = new structs_1.Queue();
