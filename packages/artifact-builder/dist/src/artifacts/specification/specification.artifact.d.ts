 ...
 */
export declare class SpecificationArtifact extends Artifact {
    private static WELL_PATH;
    private static SPECIFICATION_PATH;
    private readonly projectRoot;
    private readonly details;
    private readonly domconfigPath;
    private readonly modulePath;
    private readonly moduleFilePath;
    private readonly moduleSpecificationsDirPath;
    private readonly moduleSpecificationsWellFilePath;
    private readonly specificationPath;
    private readonly specificationClassPath;
     ...
     */
    loadSpecificationContents(): Promise<string>;
    /**
     * loadWellContents()
     *
...
//# sourceMappingURL=specification.artifact.d.ts.map