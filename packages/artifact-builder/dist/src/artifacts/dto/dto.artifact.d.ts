 ...
 */
export declare class DtoArtifact extends Artifact {
    private static WELL_PATH;
    private static DTO_PATH;
    private readonly projectRoot;
    private readonly details;
    private readonly domconfigPath;
    private readonly modulePath;
    private readonly moduleFilePath;
    private readonly moduleDtosDirPath;
    private readonly moduleDtosWellFilePath;
    private readonly dtoPath;
    private readonly dtoClassPath;
     ...
     */
    loadDtoContents(): Promise<string>;
    /**
     * loadWellContents()
     *
...
//# sourceMappingURL=dto.artifact.d.ts.map