...
<head>
    <title>Code coverage report for dates/timestamp/timestamp.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">dates/timestamp</a> timestamp.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!value) {
            // invalid argument
<span class="cstat-no" title="statement not covered" >            throw new DateException();</span>
        }
        this.date = this.toMomentObject(value).toDate();
    }
&nbsp;
    /**
     * Now()
...
&nbsp;
     ...
     */
&nbsp;
    public <span class="fstat-no" title="function not covered" >addHours(</span>numHours: number): Timestamp {
<span class="cstat-no" title="statement not covered" >        return new Timestamp(this.toMomentObject(this.date).add(numHours, 'hours').toDate());</span>
    }
&nbsp;
    /**
     * addMinutes()
     ...
     */
&nbsp;
    public <span class="fstat-no" title="function not covered" >addMinutes(</span>numMinutes: number): Timestamp {
<span class="cstat-no" title="statement not covered" >        return new Timestamp(this.toMomentObject(this.date).add(numMinutes, 'minutes').toDate());</span>
    }
&nbsp;
    /**
     * addMonths()
...
&nbsp;
    public day(): number {
        return this.toMomentObject(this.date).date();
    }
&nbsp;
    /**
     * isAfter()
     ...
     */
&nbsp;
    public <span class="fstat-no" title="function not covered" >isAfter(</span>suspect: any): boolean {
        let isAfter = <span class="cstat-no" title="statement not covered" >false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (suspect instanceof Timestamp) {</span>
            const other = <span class="cstat-no" title="statement not covered" >suspect as Timestamp;</span>
<span class="cstat-no" title="statement not covered" >            isAfter = this.toMomentObject(this.date).isAfter(other.toMomentObject(other.date));</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return isAfter;</span>
    }
&nbsp;
    /**
     * isBefore()
     ...
     */
&nbsp;
    public <span class="fstat-no" title="function not covered" >isBefore(</span>suspect: any): boolean {
        let isBefore = <span class="cstat-no" title="statement not covered" >false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (suspect instanceof Timestamp) {</span>
            const otherCreated = <span class="cstat-no" title="statement not covered" >suspect as Timestamp;</span>
<span class="cstat-no" title="statement not covered" >            isBefore = this.toMomentObject(this.date).isBefore(otherCreated.toMomentObject(otherCreated.date));</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return isBefore;</span>
    }
&nbsp;
    /**
     * equals()
     ...
     */
&nbsp;
    public <span class="fstat-no" title="function not covered" >equals(</span>suspect: any): boolean {
        let isEqual = <span class="cstat-no" title="statement not covered" >false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (suspect instanceof Timestamp) {</span>
            const other = <span class="cstat-no" title="statement not covered" >suspect as Timestamp;</span>
<span class="cstat-no" title="statement not covered" >            isEqual = this.toMomentObject(this.date).isSame(other.toMomentObject(other.date));</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return isEqual;</span>
    }
&nbsp;
    /**
     * month()
...
&nbsp;
    public month(): number {
        return this.toMomentObject(this.date).month();
    }
&nbsp;
&nbsp;
&nbsp;
...
&nbsp;
     ...
     */
&nbsp;
    public <span class="fstat-no" title="function not covered" >subtractHours(</span>numHours: number): Timestamp {
<span class="cstat-no" title="statement not covered" >        return new Timestamp(this.toMomentObject(this.date).subtract(numHours, 'h').toDate());</span>
    }
&nbsp;
    /**
     * subtractMinutes()
     ...
     */
&nbsp;
    public <span class="fstat-no" title="function not covered" >subtractMinutes(</span>numMinutes: number): Timestamp {
<span class="cstat-no" title="statement not covered" >        return new Timestamp(this.toMomentObject(this.date).subtract(numMinutes, 'm').toDate());</span>
    }
&nbsp;
    /**
     * subtractMonths()
...
&nbsp;
     ...
     */
&nbsp;
    public <span class="fstat-no" title="function not covered" >utcString(</span>): string {
<span class="cstat-no" title="statement not covered" >        return this.toMomentObject(this.date).format();</span>
    }
&nbsp;
    /**
     * value()
...
&nbsp;
    public value(): Date {
        return this.toMomentObject(this.date).toDate(); 
    }
&nbsp;
    /**
     * year()
...
&nbsp;
    public year(): number {
        return this.toMomentObject(this.date).year();
    }
&nbsp;
    /**
    ...
    private toMomentObject(date: Date): Moment {
        return moment.utc(date);
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sat Aug 22 2020 15:49:09 GMT-0400 (Eastern Daylight Time)
            </div>
        </div>
